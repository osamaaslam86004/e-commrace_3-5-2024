    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_type', models.CharField(choices=[('CUSTOMER', 'Customer'), ('SELLER', 'Seller'), ('CUSTOMER REPRESENTATIVE', 'Customer Service Representative'), ('MANAGER', 'Manager'), ('ADMINISTRATOR', 'Administrator')], max_length=50)),
                ('image', models.ImageField(blank=True, default='https://res.cloudinary.com/dh8vfw5u0/image/upload/v1702231959/rmpi4l8wsz4pdc6azeyr.ico', upload_to='images/')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('seller_profile', models.OneToOneField(default=None, on_delete=django.db.models.deletion.CASCADE, to='Homepage.userprofile')),
            ],
        ),
        migrations.CreateModel(
            name='ManagerProfile',
            fields=[
                ...
                ('manager_profile', models.OneToOneField(default=None, on_delete=django.db.models.deletion.CASCADE, to='Homepage.userprofile')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('bio', models.TextField(blank=True, null=True)),
                ('experience_years', models.PositiveIntegerField(null=True)),
                ('csr_profile', models.OneToOneField(default=None, on_delete=django.db.models.deletion.CASCADE, to='Homepage.userprofile')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('customer_profile', models.OneToOneField(default=None, on_delete=django.db.models.deletion.CASCADE, to='Homepage.userprofile')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('bio', models.TextField(blank=True, null=True)),
                ('experience_years', models.PositiveIntegerField(null=True)),
                ('admin_profile', models.OneToOneField(default=None, on_delete=django.db.models.deletion.CASCADE, to='Homepage.userprofile')),
